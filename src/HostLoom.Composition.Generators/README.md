...
also supplies the compiler-visible project directory through build-transitive props. The [performance reference](../../docs/reference/composition-performance.md) publishes measured
runtime/driver/consumer-build budgets. External consumer migration evidence remains separate.
...
[performance reference](../../docs/reference/composition-performance.md). External consumer
migration evidence remains outstanding.
