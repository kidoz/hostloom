...
public interface IPipeContext
{
    ...
    TPayload GetOrAddPayload<TPayload>(Func<TPayload> payloadFactory) where TPayload : class;
    TPayload AddOrUpdatePayload<TPayload>(Func<TPayload> addFactory, Func<TPayload, TPayload> updateFactory)
